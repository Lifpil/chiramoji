...
namespace BlindTouchOled
{
    ...
    {
        private const string AutoStartRegistryName = "BlindTouchOled";
        private const string SingleInstanceMutexName = @"Local\BlindTouchOled_SingleInstance";
        ...
        private static string BuildStartupCommand()
        {
            ...
            {
                var dllPath = Path.Combine(AppContext.BaseDirectory, "BlindTouchOled.dll");
